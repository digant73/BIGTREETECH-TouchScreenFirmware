...
void fanSetCurrentPercent(const uint8_t i, const uint8_t percent);  // set current fan percent
uint8_t fanGetCurrentPercent(const uint8_t i);                      // get current fan percent
